...
- ⚡ **Faster Lookups With Your Own ID:** Drop your SteamID64 into `Resources/Tools/my_steam_ids.txt` and it's tried *first* — if you own the game, achievement/stat lookup is an instant hit instead of walking the ~250-account list. (Set your profile's "Game details" to Public.)
